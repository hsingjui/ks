...
const adCfg = {
  ...
  luckVideoCfg = {
    ...
    'luckdrawVideo_990': reward_990,
    'luckdrawVideo_100': reward_100,
    'luckdrawVideo_990_2': reward_990_2,
    'luckdrawVideo_100_2': reward_100_2,
    ...
    for (let Z of p) {
      ...
      if (Z["task"][taskIDCfg["luckydraw"]]["needRun"]) {
        ...
        for (let U = 0; U < Z["task"][taskIDCfg["luckydraw"]]["num"]; U++) {
          ...
          runHour < 13 ? (await Z["ksNeoAdParam"](luckVideoCfg["luckdrawVideo_990"]), await selfScript["wait"](200), await Z["ksNeoAdParam"](luckVideoCfg["luckdrawVideo_990_2"]), await selfScript["wait"](200)) : (await Z["ksNeoAdParam"](luckVideoCfg["luckdrawVideo_100"]), await selfScript["wait"](200), await Z["ksNeoAdParam"](luckVideoCfg["luckdrawVideo_100_2"]), await selfScript['wait'](200));
        }
      }
